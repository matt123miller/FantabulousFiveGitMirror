using UnityEngine;
    ...
    public class ThirdPersonCharacter : MonoBehaviour
    {
        ...
        public void Move(Vector3 move, bool crouch, bool jump, bool isHanging, Vector3 m_CamForward)
        {
     ...
     public void HandleAirborneMovement()
        ...
        void HandleHangingMovement(Vector3 move, Vector3 m_CamRight)
        {
            move = (move.x * m_CamRight).normalized;
